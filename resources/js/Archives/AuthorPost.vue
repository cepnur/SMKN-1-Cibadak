<template>
    <div>
        <div
            class="posts-author-section pt-5"
            v-if="data_to_show && data_to_show.length > 0"
        >
            <h3
                class="lg:ml-0 lg:mb-6 lg:mr-0 ml-0 mb-3 mr-0 text-3xl uppercase font-bold"
                id="blog"
            >
            ...
            <div
                class="articles-feed grid grid-cols-1 gap-5"
                v-if="data_to_show && data_to_show.length > 0"
            >
                <a
                    ...
                    :href="post.link"
                    :title="post.title"
                    class="flex flex-col gap-5 border-b border-primary pb-5"
                >
            ...
            <div
                class="py-10"
                v-if="!isFetching && data && data.posts.pageInfo.hasNextPage"
            >
                <button
                    type="button"
