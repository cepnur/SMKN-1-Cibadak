  ...
  <div class="container mx-auto py-20 px-5 xl:px-0 lg:px-0">
    <div class="flex flex-col gap-4">
      ...
      <div class="flex justify-between">
        ...
        <div class="relative">
          <input v-model="searchQuery" type="text" class="py-3 bg-[#F6F6F6] rounded-lg border-none pr-10" placeholder="Search" />
          <button class="">
    ...
    <div class="py-10">
      <div class="flex gap-6">
        <div v-for="(item, index) in filteredContents" :key="index" class="md:relative lg:relative xl:relative w-1/2">
...
<style>
/* Tambahkan gaya khusus untuk tampilan komponen di sini */
</style>
